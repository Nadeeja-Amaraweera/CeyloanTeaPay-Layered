...
public interface CrudDAO<T> extends SuperDAO{
    public ObservableList<T> getAll() throws SQLException, ClassNotFoundException, Exception;
    public boolean save(T dto) throws SQLException, ClassNotFoundException, Exception;
